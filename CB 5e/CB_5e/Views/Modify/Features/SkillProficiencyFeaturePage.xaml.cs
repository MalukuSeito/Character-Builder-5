...
namespace CB_5e.Views.Modify.Features
{
	...
	public partial class SkillProficiencyFeaturePage : ContentPage
	{
        private List<string> suggestions = new List<string>();
        public ObservableRangeCollection<StringViewModel> Entries { get; set; } = new ObservableRangeCollection<StringViewModel>();
        public SkillProficiencyFeatureEditModel Model { get; private set; }
        private int move = -1;
        ...
        public SkillProficiencyFeaturePage(SkillProficiencyFeatureEditModel parent)
        {
            Model = parent;
