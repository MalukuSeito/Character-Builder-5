...
namespace Character_Builder_Builder
{
    ...
    {
        private List<MonsterSkillBonus> list;
        ...
        public List<MonsterSkillBonus> Items
        {
            get
            {
                return list;
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listBox1.SelectedItem != null)
            {
                ...
                list.Remove((MonsterSkillBonus)listBox1.SelectedItem);
            }
            fill();
        }
        ...
        {
            if (listBox1.SelectedItem != null)
                list[listBox1.SelectedIndex] = new MonsterSkillForm((MonsterSkillBonus)listBox1.SelectedItem).edit(HistoryManager);
            fill();
        }
        ...
        private void listBox1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (data is MonsterSkillBonus)
            {
                ...
                list.Insert(index, data as MonsterSkillBonus);
                fill();
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            list.Add(new MonsterSkillForm(msb).edit(HistoryManager));
            fill();
        }       
        ...
        private void copyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listBox1.SelectedItem != null)
            {
                using (StringWriter sw = new StringWriter()) {
                    Serializer.Serialize(sw, (MonsterSkillBonus)listBox1.SelectedItem);
            ...
            try
            {
                if (Clipboard.ContainsText())
                {
                    ...
                    using (StringReader sr = new StringReader(Clipboard.GetText())) {
                        list.Add((MonsterSkillBonus)Serializer.Deserialize(sr));
                        fill();
                    }
                }
            } catch (Exception) { }
