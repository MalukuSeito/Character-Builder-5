...
namespace CB_5e.Views.Modify.Features
{
	...
	public partial class SkillProficiencyChoiceFeaturePage : ContentPage
	{
        private List<string> suggestions = new List<string>();
        public ObservableRangeCollection<StringViewModel> Entries { get; set; } = new ObservableRangeCollection<StringViewModel>();
        public SkillProficiencyChoiceFeatureEditModel Model { get; private set; }
        private int move = -1;
        public string ProficiencyMultiplier
        {
            get => Model.ProficiencyMultiplier;
            set => Model.ProficiencyMultiplier = value;
        }
        public int StepperValue
        {
            get => (int)(Model.Feature.ProficiencyMultiplier / 0.5);
            set => ProficiencyMultiplier = (value * 0.5).ToString();
        }
        public string BonusType
        {
            get => Model.BonusType;
            set => Model.BonusType = value;
        }
        public List<string> BonusTypes
        {
            get => Model.BonusTypes;
        }
        public string UniqueID
        {
            get => Model.UniqueID;
            set => Model.UniqueID = value;
        }
        public int Amount
        {
            get => Model.Amount;
        ...
        {
            get => Model.OnlyAlreadyKnownSkills;
            set => Model.OnlyAlreadyKnownSkills = value;
        }

        public SkillProficiencyChoiceFeaturePage(SkillProficiencyChoiceFeatureEditModel parent)
        {
            Model = parent;
