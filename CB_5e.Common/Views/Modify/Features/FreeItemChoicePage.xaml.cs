...
namespace CB_5e.Views.Modify.Features
{
	...
	public partial class FreeItemChoicePage : ContentPage
	{
        ...
        public FreeItemChoicePage(ItemChoiceEditModel parent)
        {
            Model = parent;
